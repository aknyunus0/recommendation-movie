    ...
    <div class="form">
        <div class="login">
            <div class="login-header">
                <h3>G&#304;R&#304;&#350;</h3>
                <p>L&UumlTFEN G&#304;R&#304;&#350; BİLGİLERİNİZİ G&#304;R&#304;N&#304;Z.</p>
        ...
        <form action="/login" method="post" class="login-form">
            ...
            <p class="message">Kayıtlı de&#286;il misin? <a href="/registration">Yeni Hesap</a></p>
            <br>
            veya <a href="/catalog">Ana sayfa ile devam et</a>
        </form>
